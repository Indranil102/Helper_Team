...
//               <button class="dropdown-button-n">CHOOSE YEAR<MdOutlineKeyboardArrowDown /></button>
...
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                   <div className='info-n'>CT <RiArrowDropDownLine /></div>
//                 </div>
//                 <div className="file-table-n">
//                   <div className="file-table-header-n">
//                     <h3>Title</h3>
//                     <h3>Share By</h3>
//                   </div>
                 
//                   <div className="file-row-n">
//                       <div className="file-title-n">
//                           <LuCloudDownload />
//                           <p>May22 AN</p>
//                       </div>
//                       <div className="file-url-n">
//                           <a href={fileUrl1} >
//                               <p class="paper_link-n"><IoLinkOutline />  {getShortenedUrl(fileUrl1)}</p>
//                           </a>
//                       </div>
//                   </div>
//                   <div className="file-row-n">
...
//                               <p class="paper_link-n"><IoLinkOutline />  {getShortenedUrl(fileUrl2)}</p>
//                           </a>
//                       </div>
//                    </div>
//                    <div className="file-row-n">
...
//                               <p class="paper_link-n"><IoLinkOutline />  {getShortenedUrl(fileUrl3)}</p>
//                           </a>
//                       </div>
//                    </div>
//                    <div className="file-row-n">
...
//                               <p class="paper_link-n"><IoLinkOutline />  {getShortenedUrl(fileUrl4)}</p>
//                           </a>
//                       </div>
//                    </div>
//                    <div className="file-row-n">
...
//                               <p class="paper_link-n"><IoLinkOutline />  {getShortenedUrl(fileUrl5)}</p>
//                           </a>
//                       </div>
//                    </div>
